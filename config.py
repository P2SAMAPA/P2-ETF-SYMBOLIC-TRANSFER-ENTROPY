...
OUTPUT_REPO = "P2SAMAPA/p2-etf-symbolic-transfer-entropy-results"
...
UNIVERSES = {
    ...
    "COMBINED": [
        ...
        "SPY", "QQQ", "XLK", "XLF", "XLE", "XLV", "XLI", "XLY", "SMH", "SOXX", "XLB", "URA",
        "XLP", "XLU", "GDX", "XME", "IWF", "XSD", "XBI", "IWM", "IWD", "IWO"
    ]
}
...
ETF_BINS = 5                # discretisation bins for ETF returns
LAG = 1                     # time lag for TE
USE_CONDITIONAL_ON_TODAY = True   # if True, return TE conditional on today's macro symbol; else average TE across symbols
TOP_N = 3
